...
export async function groupUpdate(sam: any, update: any) {
    ...
    try {
        ...
        let { id, author, subject=null, desc=null, announce=null,
            ...
            ephemeralDuration=null, image=null } = update;


        const authorPlain = author.split('@')[0]
        const groupRes = await Api.get(`/groups/${id}`);

        const contactRes = await Api.get(`/contacts/lid/${author}`)
        ...
        if (announce !== null) {
            ...
            if (announce === true) text = `🔒 @${authorPlain} 𝗵𝗮 𝗰𝗲𝗿𝗿𝗮𝗱𝗼 𝗲𝗹 𝗴𝗿𝘂𝗽𝗼 𝗮 𝘀𝗼𝗹𝗼 𝗮𝗱𝗺𝗶𝗻𝘀`
            else if (announce === false) text = `🔓 @${authorPlain} 𝗵𝗮 𝗮𝗯𝗶𝗲𝗿𝘁𝗼 𝗲𝗹 𝗴𝗿𝘂𝗽𝗼 𝗮 𝘁𝗼𝗱𝗼𝘀`
            ...
            text = `📑 @${authorPlain || '𝗪𝗵𝗮𝘁𝘀𝗔𝗽𝗽𝗽'} 𝗵𝗮 𝗰𝗮𝗺𝗯𝗶𝗮𝗱𝗼 𝗲𝗹 𝗻𝗼𝗺𝗯𝗿𝗲 𝗱𝗲𝗹 𝗴𝗿𝘂𝗽𝗼 𝗮\n───────────────\n\n${group.name}\n> >>\n${updateData.name}`
            ...
            text = `📑 @${authorPlain || '𝗪𝗵𝗮𝘁𝘀𝗔𝗽𝗽𝗽'} 𝗵𝗮 𝗰𝗮𝗺𝗯𝗶𝗮𝗱𝗼 𝗹𝗮 𝗱𝗲𝘀𝗰𝗿𝗶𝗽𝗰𝗶𝗼𝗻 𝗱𝗲𝗹 𝗴𝗿𝘂𝗽𝗼 𝗮\n───────────────\n\n${group.description}\n> >>\n${desc}`

        } else if (restrict !== null) {

            updateData.restrict = restrict;

            if (restrict === true) text = `🔒 @${authorPlain} 𝗵𝗮 𝗰𝗲𝗿𝗿𝗮𝗱𝗼 𝗹𝗼𝘀 𝗮𝗷𝘂𝘀𝘁𝗲𝘀 𝗱𝗲𝗹 𝗴𝗿𝘂𝗽𝗼 𝗮 𝘀𝗼𝗹𝗼 𝗮𝗱𝗺𝗶𝗻𝘀`
            else if (restrict === false) text = `🔓 @${authorPlain} 𝗵𝗮 𝗮𝗯𝗶𝗲𝗿𝘁𝗼 𝗹𝗼𝘀 𝗮𝗷𝘂𝘀𝘁𝗲𝘀 𝗱𝗲𝗹 𝗴𝗿𝘂𝗽𝗼 𝗮 𝘁𝗼𝗱𝗼𝘀`

        } else if (joinApprovalMode !== null) {

            updateData.joinApprovalMode = joinApprovalMode;

            if (joinApprovalMode === true) text = `𝗔𝗵𝗼𝗿𝗮 𝗹𝗼𝘀 𝗮𝗱𝗺𝗶𝗻𝗶𝘀𝘁𝗿𝗮𝗱𝗼𝗿𝗲𝘀 𝗱𝗲𝗯𝗲𝗻 𝗮𝗽𝗿𝗼𝗯𝗮𝗿 𝗲𝗹 𝗶𝗻𝗴𝗿𝗲𝘀𝗼\n───────────────\n\nCambio realizado por @${authorPlain || '𝗪𝗵𝗮𝘁𝘀𝗔𝗽𝗽𝗽'}`
            ...
            text = `@${authorPlain || '𝗪𝗵𝗮𝘁𝘀𝗔𝗽𝗽𝗽'} 𝗵𝗮 𝗲𝘀𝘁𝗮𝗯𝗹𝗲𝗰𝗶𝗱𝗼 𝗹𝗮 𝗱𝘂𝗿𝗮𝗰𝗶𝗼𝗻 𝗱𝗲 𝗹𝗼𝘀 𝗺𝗲𝗻𝘀𝗮𝗷𝗲𝘀 𝗮\n───────────────\n\n${ephemeralDuration}`

        } else if (image !== null) {

            updateData.image = await sam.profilePictureUrl(id);

            text = `@${authorPlain || '𝗪𝗵𝗮𝘁𝘀𝗔𝗽𝗽𝗽'} 𝗵𝗮 𝗰𝗮𝗺𝗯𝗶𝗮𝗱𝗼 𝗹𝗮 𝗶𝗺𝗮𝗴𝗲𝗻 𝗱𝗲𝗹 𝗴𝗿𝘂𝗽𝗼`
        }

        if ( Object.keys( updateData ).length > 0 ) {
            const updateRes = await Api.patch(`/groups/${id.split('@')[0]}`, updateData)
